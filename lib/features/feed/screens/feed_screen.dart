  ...
  Widget build(BuildContext context) {
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        final isLiked = liked[index] ?? false;
        final isSaved = saved[index] ?? false;
        return _FeedCard(
          post: post,
          isLiked: isLiked,
          isSaved: isSaved,
                    ...
                    children: [
                      Expanded(
                        child: ElevatedButton.icon(
                          ...
                          label: const Text('길찾기', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w700, color: Colors.white)),
