...
// Directions API 결과(경로 폴리라인, 거리, 소요시간)를 담는 값 객체
...
// Google Maps Directions API 호출을 담당하는 서비스
class DirectionsService {
  // 빌드 시 --dart-define으로 주입되는 API 키
  static const _apiKey = String.fromEnvironment('GOOGLE_DIRECTIONS_API_KEY');

  // 출발지→목적지 도보 경로를 요청하고 폴리라인/거리/시간으로 파싱
  ...
  // Google의 인코딩된 폴리라인 문자열을 좌표 리스트로 디코딩
