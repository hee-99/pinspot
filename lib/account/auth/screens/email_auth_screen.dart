...
class _EmailAuthScreenState extends State<EmailAuthScreen>
  ...
  // 이메일/비밀번호 입력값 검증 후 로그인 시도, 성공 시 홈으로 이동
...
// 이메일 회원가입 탭 UI (닉네임/이메일/비밀번호/비밀번호 확인 입력 폼)
