...
// 최초 1회 노출되는 온보딩 화면 — 개인정보/위치/카메라·갤러리 동의를 받음
...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  // 필수 동의가 모두 완료되면 권한 요청 후 온보딩 완료 상태를 저장하고 로그인 화면으로 이동
...
// 개별 동의 항목(제목/부제/필수 배지/상세보기)을 표시하는 카드 위젯
